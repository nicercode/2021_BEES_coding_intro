...
--
  -  Tidy and intuitive coding
--

  -  Streamlined with the `tidy` data exploration/analysis framework<sup>1</sup>
...
--
  - Offers greater flexibility and customisation.
...
Install the **ggplot2** package from [CRAN](https://cran.r-project.org/web/packages/ggplot2/index.html):

```{r eval=FALSE, tidy=FALSE}
install.packages("ggplot2")
```
--
# What question can we ask from the data?
--
...
```{r fig.height=3, message=FALSE, warning=FALSE, dev='svg'}
ggplot(movies, aes(x= genre, fill=genre))+ #the device containing your data
  geom_bar() #geom and aesthetics

```
---
# Q2 What genre is expensive to produce?
--
